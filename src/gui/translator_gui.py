...
class TranslatorGUI:
    def __init__(self, lang="en"):
        ...
        self.translate_text_btn = tk.Button(self.root, text=self.t["translate"], command=self.translate_text_gui)
        self.translate_text_btn.pack(pady=10)
        
        self.translate_file_btn = tk.Button(self.root, text=self.t["translate_file"], command=self.file_translate_gui)
    ...
    def translate_text(self):
        ...
        text = self.entry.get()
        result = self.app._translate_text(text)
    ...
    def translate_file(self):
        ...
        result = "File translation not implemented yet"
